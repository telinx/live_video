...
///    by [XMaterialPageRoute.buildTransitions].
class XMaterialPageRoute<T> extends PageRoute<T> {
  /// Construct a XMaterialPageRoute whose contents are defined by [builder].
  ///
  ...
  bool canTransitionFrom(TransitionRoute<dynamic> previousRoute) {
    return previousRoute is XMaterialPageRoute || previousRoute is CupertinoPageRoute;
  }

  @override
  bool canTransitionTo(TransitionRoute<dynamic> nextRoute) {
    // Don't perform outgoing animation if the next route is a fullscreen dialog.
    return (nextRoute is XMaterialPageRoute && !nextRoute.fullscreenDialog)
